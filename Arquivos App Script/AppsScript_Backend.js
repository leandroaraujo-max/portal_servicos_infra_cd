// --- VERSÃO API: 1.0.7 (Release Oficial - Google Auth & Daemon v4) ---
...
function doGet(e) {
    // 1. ONE-CLICK APPROVAL (Action via Email Link)
    if (e && e.parameter && e.parameter.action) {
        return handleApprovalAction(e);
    }

    // 2. API ENDPOINTS (JSON responses for Daemon/Scripts)
    if (e && e.parameter && e.parameter.mode) {
        ...
        if (e.parameter.mode === 'api') {
            // Legacy Daemon Endpoint support
